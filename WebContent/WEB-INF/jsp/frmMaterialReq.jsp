...
<div class="container" id="somediv">
	<label  id="formHeading" id="lblFormHeadingName">Material Requisition</label>
	<s:form name="matReq" method="POST" action="saveMaterialReq.html?saddr=${urlHits}">
		<s:input path="strAuthorise" type="hidden" id="hidAuthorise"  name="strAuthorise" value=""></s:input>
			<div class="row transTable">
				<div class="col-md-12" style="margin: 13px 0px;">
					<a onclick="funOpenAutoGeneratedReq();" href="javascript:void(0);" style="font-size:15px; margin-top:10px;">Auto Generate</a>&nbsp&nbsp&nbsp&nbsp
					<!-- <a id="baseUrl" href="#">AttatchDocuments</a> -->
					<a onclick="funOpenExportImport()" href="javascript:void(0);" style="font-size:15px;">Export/Import</a>
				</div>
				...
				<div class="col-md-2">
					...
					<s:input id="txtreqCode" name="txtreqCode"
				...
				<div class="col-md-2">
					...
					<s:input id="txtReqDate" name="txtReqDate" path="dtReqDate" pattern="\d{1,2}-\d{1,2}-\d{4}"
						cssClass="calenderTextBox" value="${matreq.dtReqDate}" style="width:80%;" />
				</div>
				<div class="col-md-2">
					<label>Required Date</label>	
					<s:input id="txtReqiredDate" name="txtReqiredDate" path="dtReqiredDate" pattern="\d{1,2}-\d{1,2}-\d{4}"
						cssClass="calenderTextBox" value="${matreq.dtReqDate}" style="width:80%;"/>	
				</div>
					<div class="col-md-4"></div>
				<div class="col-md-2">
					<label>Location By</label>
					<s:input id="txtLocBy" name="txtLocBy" path="strLocBy" required = "true"
				...
				<div class="col-md-2">
					...
					<s:input id="txtLocOn" name="txtLocOn" path="strLocOn" required = "true"
				...
				<div class="col-md-2">	
					<input id="txtWOCode" name="txtWOCode" value="" class="searchTextBox" onclick="funHelpAgainst()" style="margin-top: 26px;"/>
				</div>
				<div class="col-md-2">
					<label id="lblQty">Qty</label>
					<input id="txtWoQty" name="txtWoQty" value="" type="text" class="BoxW116px" />
				</div>
				<div class="col-md-2">	
					<input type="Button" value="Fill" onclick="return btnFill_onclick()" class="btn btn-primary center-block" style="margin-top: 22px;"/>	
				</div>
			</div>
			<div class="row transTable">
				<div class="col-md-2">	
					<label>Product Code</label>
					<input id="txtProdCode" name="txtProdCode"
						ondblclick="funHelp('productInUse')" class="searchTextBox" />
				...
				<div class="col-md-2">
					...
					<label id="spStock" class="namelabel"></label><br>
					<span id="spStockUOM"  style="background-color:#dcdada94; width: 100%; height: 52%; margin-top: 26px; text-align: center;"></span>
				</div>
				<div class="col-md-2" style="display:none;">
					Save Standard List<s:checkbox id="cbSaveStd" value="Y"  path="strSaveSatandard" />
				</div>
				<div class="col-md-2">
					<input type="button" value="Load Standard" onclick="funLoadStandardProduct()" class="btn btn-primary center-block" style="margin-top: 22px;"></input>
				</div>
				<div class="col-md-2">
				...
				<div class="col-md-2">
					<label>Qty</label>
				    <input id="txtProdQty" type="text" class="decimal-places numberField" onkeypress="funGetKeyCode(event,'prodQty')" />
				</div>
				<div class="col-md-2">
					<label>UOM</lable>
				...
				<div class="col-md-2">
					...
					<input id="txtUnitPrice" type="text" style="text-align:right;"
				...
				<div class="col-md-2">		
					<label>Remarks</label> 
					<input id="txtRemarks"
					 name="txtRemarks" type="text" />
				</div>
				<div class="col-md-2">
					<input type="Button" id ="btnAdd" value="Add"
					onclick="return btnAdd_onclick()" class="btn btn-primary center-block" style="margin-top: 22px;" onkeypress="funGetKeyCode(event,'AddBtn')" />
				</div>
			</div>
				<br>
		<div class="dynamicTableContainer" style="height: 300px;">
			...
			<div style="background-color: #fbfafa; border: 1px solid #ccc; display: block; height: 250px; margin: auto; overflow-x: hidden; overflow-y: scroll; width: 100%;">
				<table id="tblProdDet" style="width: 104%; border: #0F0; table-layout: fixed; overflow: scroll"
		...
		<table class="transTable" style="background: #e2e2e2;">
			<tr>
				...
				<td><s:input id="txtTotalAmount" type="text"
					value="${command.dblSubTotal}" path="dblSubTotal" readonly="true" style="width: 80%" class="numberField"/>
				</td>
