            ...
            <div class="col-md-2"><label>Refund Receipt No</label>
	   	    ...
	   	    <div class="col-md-3"><label>Bill</label>
			    ...
			    <%--  <div class="col-md-6"><s:select id="cmbAgainst" items="${listAgainst}" name="cmbAgainst" path="strAgainst"></s:select></div> --%>
			     <div class="col-md-6"><s:input id="txtDocCode" path="strDocNo" readonly="readonly" ondblclick="funHelp('BillForPayment');" style="height: 95%;" class="searchTextBox" ></s:input></div>
		    </div></div>
