...
public class clsClientDetails {
	...
	public static void funAddClientCodeAndName() {
		try {
			...
			hmClientDtl.put("225.001", clsClientDetails.createClientDetails("225.001", "SHEESHA SKY LOUNGE HOSPITALITY AND SERVICES PVT LTD", dFormat.parse("2018-08-21"), dFormat.parse("2021-10-31")));//From POS 
			...
			hmClientDtl.put("240.001", clsClientDetails.createClientDetails("240.001", "THOUSAND OAKS", dFormat.parse("2018-04-12"), dFormat.parse("2020-11-17")));//renewed on 06-11-2020 for 10 days till 17-11-2020//renewed on 22-05-2019 for 1 year//renewed on 01-12-2018 for one month till 01-01-2019//renewed on 20-08-2018 for 1 week till 27-08-2018 //renewed on 13-06-2018 for 1 month// Mr. Sanjeet Lamba", 2417 East Street (G T Road),Camp, Pune 411001. Tel: (020) 2634 3194 / 2634 5598
		   ...
		   //260.001", "PARAG HOTELS AND RESORT PVT LTD" for POS
			...
			hmClientDtl.put("319.001", clsClientDetails.createClientDetails("319.001", "LAXMI FOODS", dFormat.parse("2019-06-04"), dFormat.parse("2020-10-07"))); // Released on 07-08-2019 for 1 year till 03-06-2020
			hmClientDtl.put("320.001", clsClientDetails.createClientDetails("320.001", "HOTEL SURYA", dFormat.parse("2019-06-13"), dFormat.parse("2020-11-09")));//Renewed on 24-10-2020 for 15 days//Renewed on 30-07-2020 for 1 week//Renewed on 08-11-2019 for one month till 2019-12-15//Renewed on 15-10-2019 for one month till 2019-11-15  //Renewed on 05-10-2019 till 17-10-19//Released on 24-07-2019 for 1 month till 23-08-2019//Released on 16-06-2019 for 1 week till 23-07-2019// Released on 13-06-2019 for 1 month till 15-07-2019
			...
			hmClientDtl.put("336.001", clsClientDetails.createClientDetails("336.001", "SHAH SPORTS ACADEMY PRIVATE LIMITED", dFormat.parse("2019-10-05"), dFormat.parse("2020-11-05")));//renewed on 26-06-2020 till 25-07-2020//renewed on 06-02-2020 for 1 momnth //renewed on 05-11-2019 for one month till 05-12-2019//renewed on 06-12-2019 for one month till 05-1-2020
			hmClientDtl.put("337.001", clsClientDetails.createClientDetails("337.001", "Symbiosis University", dFormat.parse("2019-10-08"), dFormat.parse("2020-04-13")));//Extended licence for month from 11-3-2020 to 13-4-2020 //Abhijit Rege  9112299043 headhospitality@symbiosis.ac.in regeabhijit@gmail.com
			hmClientDtl.put("341.001", clsClientDetails.createClientDetails("341.001", "THE FLOUR WORKS", dFormat.parse("2019-12-01"), dFormat.parse("2020-11-09")));//(Mumbai)//Released on 09-12-2019 for 1 year till 09-12-2020
			...
			hmClientDtl.put("365.001", clsClientDetails.createClientDetails("365.001", "TMF HOSPITALITY LLP", dFormat.parse("2020-07-27"), dFormat.parse("2020-11-12")));//(Mumbai)//Released on 27-07-2020 for 3 month till 27-10-2020
