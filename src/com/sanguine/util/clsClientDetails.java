...
public class clsClientDetails {
	...
	public static void funAddClientCodeAndName() {
		try {
			...
			hmClientDtl.put("117.001", clsClientDetails.createClientDetails("117.001", "THE PREM'S HOTEL", dFormat.parse("2016-08-01"), dFormat.parse("2020-07-15")));//renewed on 01-07-2020 for 15 days till 15-07-2020// HO
		   ...
		   //260.001", "PARAG HOTELS AND RESORT PVT LTD" for POS
			...
			hmClientDtl.put("320.001", clsClientDetails.createClientDetails("320.001", "HOTEL SURYA", dFormat.parse("2019-06-13"), dFormat.parse("2020-08-06")));//Renewed on 30-07-2020 for 1 week//Renewed on 08-11-2019 for one month till 2019-12-15//Renewed on 15-10-2019 for one month till 2019-11-15  //Renewed on 05-10-2019 till 17-10-19//Released on 24-07-2019 for 1 month till 23-08-2019//Released on 16-06-2019 for 1 week till 23-07-2019// Released on 13-06-2019 for 1 month till 15-07-2019
			...
			hmClientDtl.put("336.001", clsClientDetails.createClientDetails("336.001", "SHAH SPORTS ACADEMY PRIVATE LIMITED", dFormat.parse("2019-10-05"), dFormat.parse("2020-07-25")));//renewed on 26-06-2020 till 25-07-2020//renewed on 06-02-2020 for 1 momnth //renewed on 05-11-2019 for one month till 05-12-2019//renewed on 06-12-2019 for one month till 05-1-2020
