...
public class clsClientDetails {
	...
	public static void funAddClientCodeAndName() {
		try {
			...
			hmClientDtl.put("194.001", clsClientDetails.createClientDetails("194.001", "SWIG", dFormat.parse("2017-09-11"), dFormat.parse("2020-10-12"))); // Name
		   ...
		   //260.001", "PARAG HOTELS AND RESORT PVT LTD" for POS
			...
			hmClientDtl.put("320.001", clsClientDetails.createClientDetails("320.001", "HOTEL SURYA", dFormat.parse("2019-06-13"), dFormat.parse("2020-09-17")));//Renewed on 30-07-2020 for 1 week//Renewed on 08-11-2019 for one month till 2019-12-15//Renewed on 15-10-2019 for one month till 2019-11-15  //Renewed on 05-10-2019 till 17-10-19//Released on 24-07-2019 for 1 month till 23-08-2019//Released on 16-06-2019 for 1 week till 23-07-2019// Released on 13-06-2019 for 1 month till 15-07-2019
