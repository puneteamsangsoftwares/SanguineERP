...
public class clsUpdateHouseKeepingStatusController {
	...
	public ModelAndView funOpenForm(Map<String, Object> model, HttpServletRequest request) {
		...
		if (urlHits.equalsIgnoreCase("1")) {
			return new ModelAndView("frmUpdateHouseKeepingStatus", "command", new clsRoomMasterBean());
		} else {
			return new ModelAndView("frmUpdateHouseKeepingStatus_1", "command", new clsRoomMasterBean());
		}
	}
